...
exports.getAGE = function(args, res, next) {
...
exports.getFlagCodes = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getFlags = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getHISTORICAL_POPULATION = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getLOCATION = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getSEX = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getSex = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getTIME = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getTime = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getValue = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
