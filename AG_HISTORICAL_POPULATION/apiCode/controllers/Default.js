...
module.exports.getAGE = function getAGE (req, res, next) {
  Default.getAGE(req.swagger, res, next);;
};
...
module.exports.getTIME = function getTIME (req, res, next) {
  Default.getTIME(req.swagger, res, next);;
};
...
module.exports.getValue = function getValue (req, res, next) {
  Default.getValue(req.swagger, res, next);;
};

module.exports.getvisualization = function getvisualization (req, res, next) {
  Default.getvisualization(req.swagger, res, next);;
};
